...
<head>
	...
	<?php	
		// admin layout
		Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/css/admin/search.css', 'screen, projection');
    ...
    <script type="text/javascript">
		...
		function resize()
		{
			...
			var headerHeight = 10 + 10 ;
			var footerHeight = 17;
			var xPaddingMargin = 0;
...
<div id="footer">
    <div id="footer_container">
        Copyright 2013 Kelompok TKI RAAW
    </div>
</div>    
